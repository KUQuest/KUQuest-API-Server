...
export const authTestRoute = new Elysia({
  ...
  .get('/', () => Bun.file(authTestPagePath), {
    detail: {
      ...
      description:
        'Serves a browser page for testing the default Member, Quest, and finance flows.',
      operationId: 'getApiRoot',
    },
  })
  .get(
    '/test-bench/styles.css',
    () => Bun.file(resolve(process.cwd(), 'public/test-bench/styles.css')),
    {
      detail: { hide: true },
    }
  )
