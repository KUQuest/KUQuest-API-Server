  ...
  .guard(
    {
      beforeHandle: (context) => {
        ...
        if (
          !session ||
          !localFinanceTestIsEnabled ||
          !isConfiguredLocalFinanceTestUser(session.user.email)
        ) {
      ...
      guarded
        .get('/wallet', getLocalTestWallet, {
          ...
          detail: {
            ...
            description:
              'Local-only test route. Returns the four Wallet compartments for the configured Student test user.',
        ...
        .post('/payment', createLocalTestPayment, {
          ...
          detail: {
            ...
            description:
              'Local-only test route. Creates a real Xendit Test Mode Payment Request for the configured Student test user.',
        ...
        .post('/transfer', createLocalTestTransfer, {
          ...
          detail: {
            ...
            description:
              'Local-only test route. Exercises Funding Reservation, balanced Ledger settlement, and Wallet projections between two test Members.',
