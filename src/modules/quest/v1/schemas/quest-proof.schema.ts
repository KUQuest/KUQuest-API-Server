...
import { proofStatuses } from '../../shared/contracts/quest.contract';

const statusSchema = t.Union(
  proofStatuses.map((value) => t.Literal(value)) as [
...
export const proofDetailParamsSchema = t.Object({
  questId: t.String({ format: 'uuid' }),
  proofId: t.String({ format: 'uuid' }),
});
...
export const proofListResponseSchema = t.Object({
  success: t.Literal(true),
  data: t.Object({ items: t.Array(proofSchema) }),
});
