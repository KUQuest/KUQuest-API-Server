...
export const questCandidateTeamV2Route = new Elysia({
  ...
  .get('/quests/:questId/teams/:teamId', getQuestV2CandidateTeamController, {
    ...
    detail: {
      ...
      description:
        'The Hirer and Candidate Team Members can read a forming or submitted Candidate Team. Join Code plaintext is not returned by reads.',
  ...
  .patch('/quests/:questId/teams/:teamId', updateQuestV2CandidateTeamController, {
    ...
    detail: {
      ...
      description:
        'Only the Team Leader can update the name while the Candidate Team is forming for an open GROUP Candidate Quest.',
  ...
  .post('/quests/:questId/teams/:teamId/join', joinQuestV2CandidateTeamController, {
    ...
    detail: {
      ...
      description:
        'An eligible Prospective Worker joins the Candidate Team only with its current, unexpired Join Code.',
  ...
  .post('/quests/:questId/teams/:teamId/leave', leaveQuestV2CandidateTeamController, {
    ...
    detail: {
      ...
      description:
        'A forming Member can leave. If the Team Leader leaves, leadership transfers to the earliest joined remaining Member.',
      operationId: 'leaveQuestCandidateTeamV2',
      security: betterAuthSecurity,
    },
  })
  .delete(
    '/quests/:questId/teams/:teamId/members/:memberId',
    removeQuestV2CandidateTeamMemberController,
    {
  ...
  .post(
    '/quests/:questId/teams/:teamId/join-code',
    regenerateQuestV2CandidateTeamJoinCodeController,
    {
      params: questV2CandidateTeamDetailParamsSchema,
      headers: questV2CandidateTeamHeadersSchema,
      ...
      detail: {
        ...
        description:
          'Only the Team Leader can regenerate the code while the Candidate Team is forming. The previous code becomes invalid.',
  ...
  .post('/quests/:questId/teams/:teamId/select', selectQuestV2CandidateTeamController, {
    ...
    detail: {
      ...
      description:
        'The owning Hirer selects one submitted Candidate Team. The Server creates one Assignment per Member and rejects other Candidate applications and submitted Teams atomically.',
