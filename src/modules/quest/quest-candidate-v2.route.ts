...
export const questCandidateV2Route = new Elysia({
  ...
  .post('/quests/:questId/applications', createQuestV2CandidateApplicationController, {
    ...
    detail: {
      ...
      description:
        'Creates one Candidate application for an eligible Prospective Worker on a SINGLE Candidate Quest.',
  ...
  .get('/quests/:questId/applications/:applicationId', getQuestV2CandidateApplicationController, {
    ...
    detail: {
      ...
      description:
        "A Candidate can read that Candidate's application and the owning Hirer can read any application for the Quest.",
      operationId: 'getQuestApplicationV2',
      security: betterAuthSecurity,
    },
  })
  .post(
    '/quests/:questId/applications/:applicationId/withdraw',
    withdrawQuestV2CandidateApplicationController,
    {
      params: questV2CandidateApplicationDetailParamsSchema,
      headers: questV2CandidateApplicationHeadersSchema,
  ...
  .post(
    '/quests/:questId/applications/:applicationId/select',
    selectQuestV2CandidateApplicationController,
    {
      ...
      detail: {
        ...
        description:
          'The owning Hirer selects one applied Candidate. The Server creates the Assignment and rejects every other application atomically.',
