...
export const applicationDetailParamsSchema = t.Object({
  questId: t.String({ format: 'uuid' }),
  applicationId: t.String({ format: 'uuid' }),
});
export const applicationCreateSchema = t.Object(
  { reworkLimit: t.Optional(t.Integer({ minimum: 0 })) },
...
export const applicationListResponseSchema = t.Object({
  success: t.Literal(true),
  data: t.Object({ items: t.Array(applicationSchema) }),
});

export const teamParamsSchema = t.Object({ questId: t.String({ format: 'uuid' }) });
export const teamDetailParamsSchema = t.Object({
  questId: t.String({ format: 'uuid' }),
  teamId: t.String({ format: 'uuid' }),
});
export const teamMemberParamsSchema = t.Object({
  questId: t.String({ format: 'uuid' }),
  teamId: t.String({ format: 'uuid' }),
  memberId: t.String({ format: 'uuid' }),
});
export const teamCreateSchema = t.Object(
  {
    name: t.String({ minLength: 1, maxLength: 100, pattern: '\\S' }),
    reworkLimit: t.Optional(t.Integer({ minimum: 0 })),
  },
  { additionalProperties: false }
);
export const teamUpdateSchema = t.Object(
  {
    name: t.Optional(t.String({ minLength: 1, maxLength: 100, pattern: '\\S' })),
    reworkLimit: t.Optional(t.Integer({ minimum: 0 })),
  },
  { additionalProperties: false }
);
...
export const teamListResponseSchema = t.Object({
  success: t.Literal(true),
  data: t.Object({ items: t.Array(teamSchema) }),
});
export const teamMembersResponseSchema = t.Object({
  success: t.Literal(true),
  data: t.Object({ items: t.Array(memberSchema) }),
});
...
export const invitationListResponseSchema = t.Object({
  success: t.Literal(true),
  data: t.Object({ items: t.Array(invitationSchema) }),
});
...
export const candidateSelectionHeadersSchema = t.Object({
  'idempotency-key': t.String({
    ...
    maxLength: 200,
    pattern: '\\S',
    description: 'Non-blank command identity for replay-safe Candidate selection',
  }),
});
export const candidateSelectionApplicationParamsSchema = t.Object({
  questId: t.String({ format: 'uuid' }),
  applicationId: t.String({ format: 'uuid' }),
});
export const candidateSelectionTeamParamsSchema = t.Object({
  questId: t.String({ format: 'uuid' }),
  teamId: t.String({ format: 'uuid' }),
});
export const candidateSelectionResponseSchema = t.Object({
  success: t.Literal(true),
  data: t.Object({ assignments: t.Array(selectionAssignmentSchema), questStatus }),
});
