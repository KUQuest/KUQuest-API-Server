...
export const workChatRoute = new Elysia({
  ...
  .get(
    '/conversations/:conversationId/attachments/:attachmentId/link',
    getWorkConversationAttachmentLinkController,
    {
      ...
      detail: {
        ...
        description:
          'Returns a short-lived link for an attachment in a visible Work Conversation Message.',
  ...
  .delete(
    ...
    discardWorkConversationAttachmentController,
    {
      ...
      detail: {
        ...
        description:
          'Discards the authenticated current Member attachment while it remains in the composer.',
  ...
  .post('/conversations/:conversationId/messages', sendWorkConversationMessageController, {
    ...
    detail: {
      ...
      description:
        'Creates one immutable Message for a current Accepted Participant. The clientMessageId makes retries idempotent.',
