...
export const moneyPolicySchema = t.Object({
  ...
  currency: t.Literal('THB'),
  platform_fee_bps: t.Integer({ minimum: 0, maximum: 10_000 }),
  fee_rounding: t.Literal('UP_TO_WHOLE_BAHT'),
  quote_ttl_seconds: t.Integer({ minimum: 1 }),
  review_window_seconds: t.Integer({ minimum: 1 }),
  default_application_window_seconds: t.Integer({ minimum: 1 }),
