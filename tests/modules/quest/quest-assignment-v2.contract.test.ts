...
const routeContracts = [
  ...
  [
    ...
    'removeQuestCandidateTeamMemberV2',
    [200, 400, 401, 404, 409, 503],
    true,
    true,
  ],
    ...
    for (const [
      ...
      expect(
        Object.keys(operation?.responses ?? {})
          .map(Number)
          .sort((a, b) => a - b)
      ).toEqual(statuses.slice().sort((a, b) => a - b));
