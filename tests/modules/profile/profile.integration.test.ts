...
describe('profile integration', () => {
  ...
  describe('rejected input', () => {
    const cases: Array<[string, unknown]> = [
      ...
      ['a department cleared with null', { departmentId: null }],
      ...
      ['a department cleared with an empty string', { departmentId: '' }],
      ['a bio beyond the maximum length', { bio: 'a'.repeat(1001) }],
      ['a department that is not a uuid', { departmentId: 'not-a-uuid' }],
